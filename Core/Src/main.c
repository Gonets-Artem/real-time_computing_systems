...
/* Private variables ---------------------------------------------------------*/
osThreadId ErrorTask1Handle;
osThreadId MechanismTask2Handle;
osThreadId FrizerTask3Handle;
osThreadId FinishTask4Handle;
/* USER CODE BEGIN PV */
...
int main(void)
{
  ...
  /* definition and creation of MechanismTask2 */
  osThreadDef(MechanismTask2, MechanismTask, osPriorityNormal, 0, 128);
  MechanismTask2Handle = osThreadCreate(osThread(MechanismTask2), NULL);
...
/**
  * @brief  Function implementing the ErrorTask1 thread.
...
/* USER CODE BEGIN Header_MechanismTask */
/**
* @brief Function implementing the MechanismTask2 thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_MechanismTask */
void MechanismTask(void const * argument)
{
  /* Infinite loop */
  for(;;)
...
/* USER CODE BEGIN Header_FrizerTask */
/**
* @brief Function implementing the FrizerTask3 thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_FinishTask */
/**
* @brief Function implementing the FinishTask4 thread.
* @param argument: Not used
* @retval None
*/
